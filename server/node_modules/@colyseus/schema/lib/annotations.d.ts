...
export declare function schema<T extends Definition, P extends typeof Schema = typeof Schema>(fieldsAndMethods: T, name?: string, inherits?: P): SchemaWithExtends<T, P>;
