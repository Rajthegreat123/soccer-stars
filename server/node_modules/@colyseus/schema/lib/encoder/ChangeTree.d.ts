...
export declare function addToChangeTreeList(list: ChangeTreeList, changeTree: ChangeTree): ChangeTreeNode;
...
export declare function enqueueChangeTree(root: Root, changeTree: ChangeTree, changeSet: 'changes' | 'filteredChanges' | 'allFilteredChanges' | 'allChanges', queueRootNode?: ChangeTreeNode): void;
